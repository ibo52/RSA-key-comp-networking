...
class DataManipulator:
    ...
    @staticmethod
    def hex_to_bytearray(data:list):
...
if __name__=="__main__":
    ...
    b=DataManipulator.hex_to_int(a.hex())

    print("bytearray:",b,"\nstring:", DataManipulator.int_to_str(b))
    ...
    print("original:", DataManipulator.int_to_str(a), b)
    print("encrypted:", DataManipulator.int_to_str(en), en)
    print("decrypted:", DataManipulator.int_to_str(de), de)

    print("="*40)
    print("string sdeneme hex reader ile\n")
    print("-"*40)

    en=DataManipulator.bytehex_parser(a.hex())#hex deperlerini çıkar
    #en=bytearray_from_hex(en)
    
    en= Enigma.encrypt(a,rsa.PUBLIC_KEY)#şifrele
    en= DataManipulator.int_to_hex(en)#şifreli değeri hex string yap
    en= DataManipulator.hex_to_bytearray(en)#hex string listesindekileri bytearraya çevir
